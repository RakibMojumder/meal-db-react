...
const SingleMeal = ({ food, handleAddToCart }) => {
    ...
    return (
        <div>
            <div className='border rounded-md h-[445px] relative' data-aos="zoom-in" data-aos-duration="1500">
                ...
                <div className="meal-details py-5">
                    ...
                    <div className='w-full flex justify-evenly absolute bottom-5'>
                        <button onClick={() => handleAddToCart(food)} className='bg-yellow-400 text-white px-6 py-2 rounded-full'>Add To Cart</button>
